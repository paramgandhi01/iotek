      ...
      <div className="container">
        <div className="About-section-title">
         ...
         <div className="features">
          <div className="features-left" data-aos="fade-right" data-aos-duration="1500">
            <div>
              <h4>
          ...
          <div className="features-right" data-aos="fade-left" data-aos-duration="1500">
            <img src="./images/about1.svg" alt="about1"></img>
          </div>
        </div>
        <div className="features1">
          <div className="features1-left" data-aos="fade-left" data-aos-duration="1500">
            <img className="features1-img" src="./images/about2.svg"></img>
          </div>
          <div className="features1-right" data-aos="fade-right" data-aos-duration="1500">
            <div>
              <h4>
                Modern design with Essential <br /> Features
              </h4>
